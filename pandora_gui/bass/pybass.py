...
if platform.system().lower() == 'windows':
	...
	try:
		bass_module = ctypes.CDLL('../Frameworks/libbass.dylib')
	except:
...
BASS_FX_DX8_CHORUS = 1
BASS_FX_DX8_COMPRESSOR = 2
BASS_FX_DX8_DISTORTION = 3
BASS_FX_DX8_ECHO = 4
BASS_FX_DX8_FLANGER = 5
BASS_FX_DX8_GARGLE = 6
BASS_FX_DX8_I3DL2REVERB = 7
BASS_FX_DX8_PARAMEQ = 8
BASS_FX_DX8_REVERB = 9
